...
export function getSearchUrl(params: { location?: string; date?: string; performerTypes?: string }): string {
          ...
          <View style={styles.section}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.chips}>
              <TouchableOpacity
                ...
                onPress={() => { setPerformerType(''); setTypePickerVisible(false); }}
              >
              ...
              {performerTypes.map((t) => (
                <TouchableOpacity
                  ...
                  onPress={() => { setPerformerType(t.slug); setTypePickerVisible(false); }}
                >
