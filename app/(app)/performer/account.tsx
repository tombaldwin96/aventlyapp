    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.card}>
        ...
        <Text style={styles.desc}>
          Update your name, phone and booking details on the web dashboard.
        </Text>
        <TouchableOpacity
          style={styles.button}
          onPress={() => Linking.openURL(getDashboardUrl('/account'))}
          activeOpacity={0.8}
        >
          <Text style={styles.buttonText}>Open account on web</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
