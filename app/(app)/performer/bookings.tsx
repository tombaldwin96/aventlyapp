    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.card}>
        ...
        <Text style={styles.desc}>
          View and respond to all your booking requests, confirm dates and manage your calendar on the web dashboard.
        </Text>
        <TouchableOpacity
          style={styles.button}
          onPress={() => Linking.openURL(getDashboardUrl('/bookings'))}
          activeOpacity={0.8}
        >
          <Text style={styles.buttonText}>Open bookings on web</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
